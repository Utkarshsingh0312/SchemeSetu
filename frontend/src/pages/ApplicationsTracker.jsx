  ...
  return (
    <div className="min-h-screen py-10 max-w-6xl mx-auto px-4 sm:px-7 space-y-6">
      ...
      <div className="bg-card border border-navy/20 rounded-lg p-6 sm:p-8">
        ...
        <h1 className="font-serif font-bold text-3xl text-navy mb-2">APPLICATION TRACKER</h1>
        <p className="text-xs font-mono text-ink-soft">
          Track your application workflow from document preparation to final government approval.
        </p>
      </div>

      {loading ? (
        <div className="text-center py-10 font-mono text-xs text-ink-soft">Loading application workflow...</div>
              ...
              <div key={id} className="bg-card border border-navy/20 p-6 sm:p-8 rounded-lg space-y-6 shadow-sm">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-navy/15 pb-4">
                  <div>
                    ...
                    <div className="text-xs font-serif font-semibold text-gold-deep mt-0.5">Benefit: {scheme.benefit}</div>
                  </div>

                  <div className="flex items-center gap-3">
                    <span className="font-mono text-xs text-navy font-bold">Status:</span>
                    <select
                      value={status}
                ...
                {/* Workflow Visual Timeline Stepper (Requirement 22) */}
        ...
        <div className="bg-card border border-navy/15 p-12 text-center rounded-lg space-y-4">
          ...
          <h3 className="font-serif font-bold text-lg text-navy">No active applications being tracked</h3>
          <p className="text-xs text-ink-soft max-w-sm mx-auto font-sans">
            Save schemes to your passbook and start tracking application milestones here.
          </p>
